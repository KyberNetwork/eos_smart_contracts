...
OTA_RESERVE_ACCOUNT="yolorese1132"
OTB_RESERVE_ACCOUNT="yolorese1133"
OTC_RESERVE_ACCOUNT="yolorese1134"
OTD_RESERVE_ACCOUNT="yolorese1135"
NTA_RESERVE_ACCOUNT="yolorese1141"
NTB_RESERVE_ACCOUNT="yolorese1142"
...
$jleos push action eosio.token transfer "[ \"$ACCOUNT_NAME\", \"$OTD_RESERVE_ACCOUNT\", \"7.1300 EOS\", "deposit" ]" -p $ACCOUNT_NAME@active
...
$jleos push action $ANOTHER_TOKEN_ACCOUNT create "[ \"$ANOTHER_TOKEN_ACCOUNT\", \"1000000000.00 NTC\"]" -p $ANOTHER_TOKEN_ACCOUNT@active
$jleos push action $ANOTHER_TOKEN_ACCOUNT create "[ \"$ANOTHER_TOKEN_ACCOUNT\", \"1000000000.0 NTD\"]" -p $ANOTHER_TOKEN_ACCOUNT@active

#move tokens to reserves acccounts
sleep 1
$jleos push action $TOKEN_ACCOUNT transfer "[ \"$RESERVE_OWNER_ACCOUNT\", \"$OTA_RESERVE_ACCOUNT\", \"10000.0000 OTA\", \"memo\" ]" -p $RESERVE_OWNER_ACCOUNT@active
$jleos push action $TOKEN_ACCOUNT transfer "[ \"$RESERVE_OWNER_ACCOUNT\", \"$OTB_RESERVE_ACCOUNT\", \"10000.000 OTB\", \"memo\" ]" -p $RESERVE_OWNER_ACCOUNT@active
$jleos push action $TOKEN_ACCOUNT transfer "[ \"$RESERVE_OWNER_ACCOUNT\", \"$OTC_RESERVE_ACCOUNT\", \"10000.00 OTC\", \"memo\" ]" -p $RESERVE_OWNER_ACCOUNT@active
$jleos push action $TOKEN_ACCOUNT transfer "[ \"$RESERVE_OWNER_ACCOUNT\", \"$OTD_RESERVE_ACCOUNT\", \"10000.0 OTD\", \"memo\" ]" -p $RESERVE_OWNER_ACCOUNT@active
$jleos push action $ANOTHER_TOKEN_ACCOUNT transfer "[ \"$RESERVE_OWNER_ACCOUNT\", \"$NTA_RESERVE_ACCOUNT\", \"10000.0000 NTA\", \"memo\" ]" -p $RESERVE_OWNER_ACCOUNT@active
$jleos push action $ANOTHER_TOKEN_ACCOUNT transfer "[ \"$RESERVE_OWNER_ACCOUNT\", \"$NTB_RESERVE_ACCOUNT\", \"10000.000 NTB\", \"memo\" ]" -p $RESERVE_OWNER_ACCOUNT@active
$jleos push action $ANOTHER_TOKEN_ACCOUNT transfer "[ \"$RESERVE_OWNER_ACCOUNT\", \"$NTC_RESERVE_ACCOUNT\", \"10000.00 NTC\", \"memo\" ]" -p $RESERVE_OWNER_ACCOUNT@active
$jleos push action $ANOTHER_TOKEN_ACCOUNT transfer "[ \"$RESERVE_OWNER_ACCOUNT\", \"$NTD_RESERVE_ACCOUNT\", \"10000.0 NTD\", \"memo\" ]" -p $RESERVE_OWNER_ACCOUNT@active

###$jleos push action eosio.token transfer "[ \"$ACCOUNT_NAME\", \"$OTA_RESERVE_ACCOUNT\", \"3.0000 EOS\", "deposit" ]" -p $ACCOUNT_NAME@active
...
$jleos set contract $OTB_RESERVE_ACCOUNT contracts/Reserve/AmmReserve AmmReserve.wasm --abi AmmReserve.abi -p $OTB_RESERVE_ACCOUNT@active
$jleos set contract $OTC_RESERVE_ACCOUNT contracts/Reserve/AmmReserve AmmReserve.wasm --abi AmmReserve.abi -p $OTC_RESERVE_ACCOUNT@active
$jleos set contract $OTD_RESERVE_ACCOUNT contracts/Reserve/AmmReserve AmmReserve.wasm --abi AmmReserve.abi -p $OTD_RESERVE_ACCOUNT@active
...
$jleos set contract $NTB_RESERVE_ACCOUNT contracts/Reserve/AmmReserve AmmReserve.wasm --abi AmmReserve.abi -p $NTB_RESERVE_ACCOUNT@active
$jleos set contract $NTC_RESERVE_ACCOUNT contracts/Reserve/AmmReserve AmmReserve.wasm --abi AmmReserve.abi -p $NTC_RESERVE_ACCOUNT@active
$jleos set contract $NTD_RESERVE_ACCOUNT contracts/Reserve/AmmReserve AmmReserve.wasm --abi AmmReserve.abi -p $NTD_RESERVE_ACCOUNT@active

#init 
$jleos push action $OTA_RESERVE_ACCOUNT  init "[\"$RESERVE_OWNER_ACCOUNT\", \"$NETWORK_ACCOUNT\", \"4,OTA\", \"$TOKEN_ACCOUNT\", \"$EOS_ACCOUNT\", true ]" -p $OTA_RESERVE_ACCOUNT@active
$jleos push action $OTB_RESERVE_ACCOUNT  init "[\"$RESERVE_OWNER_ACCOUNT\", \"$NETWORK_ACCOUNT\", \"3,OTB\", \"$TOKEN_ACCOUNT\", \"$EOS_ACCOUNT\", true ]" -p $OTB_RESERVE_ACCOUNT@active
$jleos push action $OTC_RESERVE_ACCOUNT  init "[\"$RESERVE_OWNER_ACCOUNT\", \"$NETWORK_ACCOUNT\", \"2,OTC\", \"$TOKEN_ACCOUNT\", \"$EOS_ACCOUNT\", true ]" -p $OTC_RESERVE_ACCOUNT@active
$jleos push action $OTD_RESERVE_ACCOUNT  init "[\"$RESERVE_OWNER_ACCOUNT\", \"$NETWORK_ACCOUNT\", \"1,OTD\", \"$TOKEN_ACCOUNT\", \"$EOS_ACCOUNT\", true ]" -p $OTD_RESERVE_ACCOUNT@active
$jleos push action $NTA_RESERVE_ACCOUNT  init "[\"$RESERVE_OWNER_ACCOUNT\", \"$NETWORK_ACCOUNT\", \"4,NTA\", \"$ANOTHER_TOKEN_ACCOUNT\", \"$EOS_ACCOUNT\", true ]" -p $NTA_RESERVE_ACCOUNT@active
$jleos push action $NTB_RESERVE_ACCOUNT  init "[\"$RESERVE_OWNER_ACCOUNT\", \"$NETWORK_ACCOUNT\", \"3,NTB\", \"$ANOTHER_TOKEN_ACCOUNT\", \"$EOS_ACCOUNT\", true ]" -p $NTB_RESERVE_ACCOUNT@active
$jleos push action $NTC_RESERVE_ACCOUNT  init "[\"$RESERVE_OWNER_ACCOUNT\", \"$NETWORK_ACCOUNT\", \"2,NTC\", \"$ANOTHER_TOKEN_ACCOUNT\", \"$EOS_ACCOUNT\", true ]" -p $NTC_RESERVE_ACCOUNT@active
$jleos push action $NTD_RESERVE_ACCOUNT  init "[\"$RESERVE_OWNER_ACCOUNT\", \"$NETWORK_ACCOUNT\", \"1,NTD\", \"$ANOTHER_TOKEN_ACCOUNT\", \"$EOS_ACCOUNT\", true ]" -p $NTD_RESERVE_ACCOUNT@active
...
$jleos push action $OTB_RESERVE_ACCOUNT setparams '[ "0.1", "0.04", "20.0000 EOS", "20.0000 EOS", "0.25", "0.5555", "0.00000555" ]' -p $RESERVE_OWNER_ACCOUNT@active
$jleos push action $OTC_RESERVE_ACCOUNT setparams '[ "0.1", "0.03", "20.0000 EOS", "20.0000 EOS", "0.25", "0.5555", "0.00000555" ]' -p $RESERVE_OWNER_ACCOUNT@active
$jleos push action $OTD_RESERVE_ACCOUNT setparams '[ "0.1", "0.02", "20.0000 EOS", "20.0000 EOS", "0.25", "0.5555", "0.00000555" ]' -p $RESERVE_OWNER_ACCOUNT@active
...
$jleos push action $NTB_RESERVE_ACCOUNT setparams '[ "0.1", "0.04", "20.0000 EOS", "20.0000 EOS", "0.25", "0.5555", "0.00000555" ]' -p $RESERVE_OWNER_ACCOUNT@active
$jleos push action $NTC_RESERVE_ACCOUNT setparams '[ "0.1", "0.03", "20.0000 EOS", "20.0000 EOS", "0.25", "0.5555", "0.00000555" ]' -p $RESERVE_OWNER_ACCOUNT@active
$jleos push action $NTD_RESERVE_ACCOUNT setparams '[ "0.1", "0.02", "20.0000 EOS", "20.0000 EOS", "0.25", "0.5555", "0.00000555" ]' -p $RESERVE_OWNER_ACCOUNT@active
...
#list reserve pairs
$jleos push action $NETWORK_ACCOUNT listpairres "[ \"$OTA_RESERVE_ACCOUNT\", \"4,OTA\", \"$TOKEN_ACCOUNT\", true ]" -p $NETWORK_OWNER_ACCOUNT@active
$jleos push action $NETWORK_ACCOUNT listpairres "[ \"$OTB_RESERVE_ACCOUNT\", \"3,OTB\", \"$TOKEN_ACCOUNT\", true ]" -p $NETWORK_OWNER_ACCOUNT@active
$jleos push action $NETWORK_ACCOUNT listpairres "[ \"$OTC_RESERVE_ACCOUNT\", \"2,OTC\", \"$TOKEN_ACCOUNT\", true ]" -p $NETWORK_OWNER_ACCOUNT@active
$jleos push action $NETWORK_ACCOUNT listpairres "[ \"$OTD_RESERVE_ACCOUNT\", \"1,OTD\", \"$TOKEN_ACCOUNT\", true ]" -p $NETWORK_OWNER_ACCOUNT@active
$jleos push action $NETWORK_ACCOUNT listpairres "[ \"$NTA_RESERVE_ACCOUNT\", \"4,NTA\", \"$ANOTHER_TOKEN_ACCOUNT\", true ]" -p $NETWORK_OWNER_ACCOUNT@active
$jleos push action $NETWORK_ACCOUNT listpairres "[ \"$NTB_RESERVE_ACCOUNT\", \"3,NTB\", \"$ANOTHER_TOKEN_ACCOUNT\", true ]" -p $NETWORK_OWNER_ACCOUNT@active
$jleos push action $NETWORK_ACCOUNT listpairres "[ \"$NTC_RESERVE_ACCOUNT\", \"2,NTC\", \"$ANOTHER_TOKEN_ACCOUNT\", true ]" -p $NETWORK_OWNER_ACCOUNT@active
$jleos push action $NETWORK_ACCOUNT listpairres "[ \"$NTD_RESERVE_ACCOUNT\", \"1,NTD\", \"$ANOTHER_TOKEN_ACCOUNT\", true ]" -p $NETWORK_OWNER_ACCOUNT@active
...
# complete a sell
$jleos push action $TOKEN_ACCOUNT transfer "[ \"$ALICE_ACCOUNT\", \"$NETWORK_ACCOUNT\", \"0.0100 OTA\", \"4 EOS,$MOSHE_ACCOUNT,0.000001\" ]" -p $ALICE_ACCOUNT@active
