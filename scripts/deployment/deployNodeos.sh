...
cleos push action reserve1 setparams '[ "0.01", "0.05", "20.0000 EOS", "20.0000 EOS", "0.25", "0.5555", "0.00000555" ]' -p resowner@active
...
cleos push action network listpairres '[ "reserve", "4,SYS", "eosio.token", true ]' -p netowner@active
cleos push action network listpairres '[ "reserve1", "4,OTA", "other.token", true ]' -p netowner@active
#cleos push action network listpairres '[ "reserve2", "4,SYS", "eosio.token", true ]' -p netowner@active

#cleos push action network listpairres '[ "reserve1", "4,SYS", "eosio.token", false ]' -p netowner@active
#cleos push action network listpairres '[ "reserve2", "4,SYS", "eosio.token", false ]' -p netowner@active

cleos get table network network reservespert

# test trade for first reserve
cleos get table reserve reserve rate
cleos push action eosio.token transfer '[ "alice", "network", "0.0100 SYS", "4 EOS,moshe,0.000001" ]' -p alice@active
cleos get table reserve reserve rate

cleos get table reserve reserve rate
cleos push action eosio.token transfer '[ "alice", "network", "0.0100 EOS", "4 SYS,moshe,0.000001" ]' -p alice@active
cleos get table reserve reserve rate

# test trade for second reserve
cleos get table reserve1 reserve1 rate
cleos push action other.token transfer '[ "alice", "network", "0.0100 OTA", "4 EOS,moshe,0.000001" ]' -p alice@active
cleos get table reserve1 reserve1 rate


cleos get table reserve1 reserve1 rate
cleos push action eosio.token transfer '[ "alice", "network", "0.0100 EOS", "4 OTA,moshe,0.000001" ]' -p alice@active
cleos get table reserve1 reserve1 rate
